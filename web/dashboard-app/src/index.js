(function () {
  ...
  // google.charts.setOnLoadCallback(loadTeacherData);
...
let teacher1 = parseTeacher(tfr);
const teacher2 = parseTeacher(tfrot);
...
function drawChart(type, dataTable, contId, options) {
